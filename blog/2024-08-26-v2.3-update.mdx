---
slug: v2.3-update
title: Update V2.3 - Cosmos 
authors: [horizon]
tags: [horizon, updates, v2]
---

## :clipboard: HORIZON UPDATE V2.3-COSMOS • 24/08/24 :tada:
...
Stay updated on upcoming space missions with the new `/nextlaunch` command. Access detailed articles on forthcoming launches with the latest updates, schedules, and mission details, keeping you connected to all the action.
